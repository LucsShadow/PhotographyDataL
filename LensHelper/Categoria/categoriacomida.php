			...
			<?php
				...
				<article id="main">
					<header class="special container">
						...
						<h2>A categoria selecionada foi <strong>Comida</strong>, aqui você vai <br>ver as lentes para sua câmera.</h2>
						<br>
		                    <ul class="buttons">
		                        <li><a href="#pagabaixo" class="button fit scrolly">Descobrir</a></li>
		                    </ul>
					</header>
					<!-- One -->
								...
								<div class="content">
									<section>
										...
										<p>
											...
											<br><br>
											Usar muito este recurso a seu favor, irá destacar as partes suculentas da comida. Fazer algumas fotos dando destaque máximo a esses pontos e tento causar a sensação de sabor através do olhar.
										</p>
